...
Sync-Unicorn -ControlPanelUrl '$sc_url$/unicorn.aspx' -SharedSecret '749CABBC85EAD20CE55E2C6066F1BE375D2115696C8A8B24DB6ED1FD60613086' -DebugSecurity -StreamLogs

# SYNC SPECIFIC CONFIGURATIONS
#Sync-Unicorn -ControlPanelUrl '$sc_url$/unicorn.aspx' -SharedSecret 'your-sharedsecret-here'  -Configurations @('Test1', 'Test2') -StreamLogs

# SYNC ALL CONFIGURATIONS, SKIPPING ANY WITH TRANSPARENT SYNC ON
#Sync-Unicorn -ControlPanelUrl '$sc_url$/unicorn.aspx' -SharedSecret 'your-sharedsecret-here' -SkipTransparentConfigs -StreamLogs
...
#Sync-Unicorn -ControlPanelUrl '$sc_url$/unicorn.aspx' -SharedSecret 'your-sharedsecret-here' -Verb 'SyncSilent'
